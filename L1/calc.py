...
# operators = [19,15,8,1,4,4,4,1,12,4,1,1,3,1,2] # Pascal
# operators = [19,14,5,8,4,4,5,1,1,1,15,4,1,1,1,1,2,3,1] # С
operators = [3,17,3,33,4,7,2,3,1,2,4,4,3,4,6,5,1,2,1,1,1,2,1,2,1,3,1,1,1,1,1]

# operands = [1,1,3,1,3,1,2,2,1,3,7,5,6,3,5,3,4,2,6,2] # Pascal
# operands = [1,1,3,1,3,1,2,2,3,6,5,6,2,5,3,4,2,6,4] # C
operands = [7,7,1,7,59,29,3,1,1,1,2,4,4,2,6,5,4,4,2,3,5,13,3,1,5,4,6,3,1,1,2,2,2,1,1,1]
